...
begin
  ...
  begin
    with DataModule3.querySatuan do
    begin
      SQL.Clear;
      SQL.Text := sqlText;
...
begin
  edtName.Text := DataModule3.querySatuan.Fields[1].AsString;
  edtDeskripsi.Text := DataModule3.querySatuan.Fields[2].AsString;
  idSatuan := StrToInt(DataModule3.querySatuan.Fields[0].AsString);
...
procedure TFormSatuan.btnLaporanClick(Sender: TObject);
begin
 DataModule3.frxrprt2.ShowReport();
end;
