...
uses
  ...
  Dialogs, Menus,Unit2, Unit5, Satuan, Supplier, fiture_customer;
...
procedure TFormViewMenu.KUSTOMER1Click(Sender: TObject);
var form: TFormKustomer;
begin
  form := TFormKustomer.Create(Application);
  form.ShowModal;
end;
